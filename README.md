...
#This project contains data on X (insert whatever the data is). The src folder contains all scripts, including scripts that load/munge data, and scripts that transform the data. The Data folder contains a link to the raw data, and the processed data.
